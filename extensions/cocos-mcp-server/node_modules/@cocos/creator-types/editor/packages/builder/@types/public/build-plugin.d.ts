import { ITextureCompressType, IPVRQuality, IASTCQuality, IETCQuality, ITextureFormatInfo } from '@cocos/creator-types/editor/packages/builder/@types/public/texture-compress';
import { IBuildTaskOption, IConsoleType } from '@cocos/creator-types/editor/packages/builder/@types/public/options';
import { IBuildResult } from '@cocos/creator-types/editor/packages/builder/@types/public/build-result';
