...
import { IPolyFills, IBuildDesignResolution, IBuildOptionBase, IBuildTaskOption, ITaskItemJSON, BundleCompressionType, IPhysicsConfig, IBundleOptions, Platform, BundleFilterConfig } from '@cocos/creator-types/editor/packages/builder/@types/public';
import { IAssetMeta } from '@cocos/creator-types/editor/packages/asset-db/@types/protected';
import { IAssetInfo as IAssetInfoFromDB } from '@cocos/creator-types/editor/packages/asset-db/@types/public';
import * as rollup from 'rollup';
import { EngineInfo } from '@cocos/creator-types/editor/packages/engine/@types';
import { BuiltinBundleName } from '@cocos/creator-types/editor/packages/builder/@types/protected/bundle-config';
