import { IAsset } from '@cocos/creator-types/editor/packages/asset-db/@types/private';
import { BundleCompressionType, IAssetPathInfo, IBuildPaths, IBuildTaskOption, IBundleConfig, IJsonPathInfo, ISettings, UUID, IBuildSceneItem, ITextureCompressType, ITextureCompressFormatType, ICustomConfig } from '@cocos/creator-types/editor/packages/builder/@types/public';
import { BuilderAssetCache } from '@cocos/creator-types/editor/packages/builder/@types/protected/asset-manager';
import { ImportMap, ImportMapWithImports } from '@cocos/creator-types/editor/packages/builder/@types/protected/import-map';
import { IAssetInfo, IImportMapOptions, IInternalBuildOptions } from '@cocos/creator-types/editor/packages/builder/@types/protected/options';
import { IPacInfo } from '@cocos/creator-types/editor/packages/builder/@types/protected/texture-packer';
