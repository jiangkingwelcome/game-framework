...
import { IBuildSceneItem, UUID } from '@cocos/creator-types/editor/packages/builder/@types/public';
import { IInternalBuildOptions, IAssetInfo } from '@cocos/creator-types/editor/packages/builder/@types/protected/options';
