...
import { ISplashSetting, ICustomJointTextureLayout, UUID, IPhysicsConfig, IOrientation } from '@cocos/creator-types/editor/packages/builder/@types/public/options';
