...
import { IBundle, InternalBuildResult, ScriptBuilder, IBundleManager } from '@cocos/creator-types/editor/packages/builder/@types/protected/build-result';
import { IInternalBuildOptions, IInternalBundleBuildOptions } from '@cocos/creator-types/editor/packages/builder/@types/protected/options';
import { ImportMap } from '@cocos/creator-types/editor/packages/builder/@types/protected/import-map';
import { IImportMapOptions, IPlatformType } from '@cocos/creator-types/editor/packages/builder/@types/protected/options';
