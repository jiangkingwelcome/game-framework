...
import { IAsset } from '@cocos/creator-types/editor/packages/asset-db/@types/protected/asset';
import { IAssetInfo, QueryAssetsOption } from '@cocos/creator-types/editor/packages/asset-db/@types/public';
