                        ...
                        case "int[]":
                            ...
                            if (value && value.toString().trim() !== "") {
                                ...
                                if (strVal.startsWith("[")) {
                                    ...
                                    // 逗号分隔格式
                                    data[key] = strVal.split(",").map((v) => parseInt(v.trim())).filter((v) => !isNaN(v));
                                }
                            }
                            else {
                                data[key] = [];
                        ...
                        case "string[]":
                            ...
                            if (value && value.toString().trim() !== "") {
                                ...
                                if (strVal.startsWith("[")) {
                                    ...
                                    // 逗号分隔格式
                                    data[key] = strVal.split(",").map((v) => v.trim());
                                }
                            }
                            else {
                                data[key] = [];
                        ...
                        case "float[]":
                            ...
                            if (value && value.toString().trim() !== "") {
                                ...
                                if (strVal.startsWith("[")) {
                                    ...
                                    data[key] = strVal.split(",").map((v) => parseFloat(v.trim())).filter((v) => !isNaN(v));
                                }
                            }
                            else {
                                data[key] = [];
